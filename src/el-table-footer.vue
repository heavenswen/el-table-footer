  ...
  >
    ...
    <div
      ...
      :style="{
        ...
        right: table && table.layout.gutterWidth + 'px'
      }"
    >
      <table-footer
        :data="data"
...
<style>
  ...
  .el-table-footer-wrapper tbody td {
  ...
  .el-table-footer-wrapper .cell,
  .el-table-footer-wrapper th div{
    padding-left: 10px;
  }
  .el-table-footer-wrapper--border td {
    border-right: 1px solid #EBEEF5;
  }
  .el-table-footer-wrapper--border th.gutter:last-of-type {
    border-bottom: 1px solid #EBEEF5;
